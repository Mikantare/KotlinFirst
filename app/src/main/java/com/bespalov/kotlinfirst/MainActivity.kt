package com.bespalov.kotlinfirst
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val askMeButton: Button = findViewById(R.id.askMeButton)
    ...
    private fun shakeBall() {
        ...
        val randomChoise = Random.nextInt(20) +1
        val imageResources = when (randomChoise) {
        ...
        ballImageView.setImageResource(imageResources)
    }
